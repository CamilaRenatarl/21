...
function spawnDoors()
 {
  ...
  if (frameCount % 240 === 0) {
    ...
    var climber = createSprite(200,10);//10
   
    var invisibleBlock = createSprite(200,15);//15
    invisibleBlock.width = climber.width;
   
    invisibleBlock.height = 2;
    //agregar la función random
  door.x=Math.round(random(550,50))
  climber.x=door.x
  invisibleBlock.x=climber.x
  invisibleBlock.x=door.x

  //climber.x=Math.round(random(550,50))
  // invisibleBlock.x=Math.round(random(550,50))
  //doorsGroup.x=Math.round(random(50,550))
 // climbersGroup.x=Math.round(random(50,550))
   //invisibleBlockGroup.x=Math.round(random(50,550))
